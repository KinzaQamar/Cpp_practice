//This example explain the use of run time polymorphism as well as use of pointers with derived classes
//10-Dec-2023
...
int main() {
    ...
    b2 = &d1;
    b2->print();
    b2->set_a(8); //same as d1.set_a(8)
    b2->set_b(9);
    b2->print(); //run time function -- do function binding at run time to derived :: print()
