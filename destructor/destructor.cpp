//This program contains the c++ instructions for destructor
//05-Dec-2023
...
class Point1 {
    ...
    public:
        ...
        ~Point1() { //No return value or arguments
            cout<<endl<<"\033[1;31m[DESTRUCTOR]\033[0m Destroying the object";
        }

        Point1(Point1 &obj) { //Copy constructor
            cout<<endl<<"\033[1;33m[COPY CONSTRUCTOR]\033[0m";
            ix1 = obj.ix1;
            iy1 = obj.iy1;
            fx1 = obj.fx1;
            fy1 = obj.fy1;        
        ...
        void print() {
            cout<<endl<<"The integer coordinates of point are  (x,y) : ("<<ix1<<","<<iy1<<")"<<endl;
...
int main () {
    ...
    cout<<"Enter integer x and y coodinates for P1:"<<endl;
    cout<<"x : ";
    cin>>x;
    cout<<"y : ";
    cin>>y;
    ...
    cout<<endl;
    cout<<"Enter floating x and y coodinates for P2:"<<endl;
    cout<<"x : ";
    cin>>a;
    cout<<"y : ";
    cin>>b;
